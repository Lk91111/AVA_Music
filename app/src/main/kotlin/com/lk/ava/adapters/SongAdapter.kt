...
class SongAdapter (
    ...
    override fun onBindViewHolder(holder: RVVH, position: Int) {
        ...
        holder.songName.typeface =
            Typeface.createFromAsset(holder.songName.context.assets, "fonts/body.ttf")
        holder.artistName.typeface =
            Typeface.createFromAsset(holder.artistName.context.assets, "fonts/body.ttf")
        if (showArt) {
            holder.albumArt.run {
                if (this != null) {
                    File(
